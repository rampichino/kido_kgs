...
function getContainer(container, defaultContainer) {
  ...
  return (container && ReactDOM.findDOMNode(container)) || defaultContainer;
}

function ownerDocument2(componentOrElement2) {
  if (componentOrElement2 && componentOrElement2.nodeType) {
    return ownerDocument(componentOrElement2);
  }
  return document;
}
...
export class Portal extends React.Component {
  ...
  UNSAFE_componentWillMount() {
    ...
    if (container && !container.nodeType && !ReactDOM.findDOMNode(container)) {
